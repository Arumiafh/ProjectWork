              ...
              <table id="example1" class="table table-bordered table-striped table-hover table-responsive">
                ...
                foreach ($admin as $data) {
                  ...
                  <tr>
                    ...
                    '; if($total_a > 1){
                      echo '<td><a href="#" data-toggle="modal" data-target="#role'.$data->PETUGAS_ID.'" class="btn btn-warning btn-sm">Role</a></td>';
                    } echo '
                    <td><a href="'.base_url().'index.php/petugas/edit_admin/'.$data->PETUGAS_ID.'" class="btn btn-info btn-sm" style="margin-right: 5px">Edit</a>
                    ';
                    if($total_a > 1){
                      echo '
                   <td> <a href="'.base_url().'index.php/petugas/del_admin/'.$data->PETUGAS_ID.'" class="btn btn-sm btn-danger">Delete</a>  </td>
                    ';} echo'
                    </td>
                  </tr>
             ...
             <div class="modal fade" id="tambahAdmin">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <form method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>index.php/petugas/add_admin">
              ...
              <div class="modal fade" id="role'.$data->PETUGAS_ID.'">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <form method="post" enctype="multipart/form-data" action="'.base_url().'index.php/petugas/role_admin/'.$data->PETUGAS_ID.'">
